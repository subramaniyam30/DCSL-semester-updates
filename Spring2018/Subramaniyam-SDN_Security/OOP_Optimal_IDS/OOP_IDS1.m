classdef OOP_IDS1 < handle
    ...
    properties
        ...
        weight = 0.4             % importance of relative cost  wrt performance -> (0 < weight < 1)
    ...
    methods
        ...
        function obj=OOP_IDS1(graphKey,servers,connections)
...
%                             return;
        ...
        function updateEdgeWeightPredecessor(obj,alertNode)
            ...
            for i=1:size(allpaths,1)
                ...
                obj.edgeWeightAttacker(index,:).weight=obj.edgeWeightAttacker(index,:).weight+ EW_increase;
                end  
            end
...
%         end
        ...
        function updateEdgeWeightDistance(obj,alertNode)
            ...
            for i=1:size(allpaths,1)
                ...
                %obj.edgeWeightAttacker(index,:).weight=obj.edgeWeightAttacker(index,:).weight+ (10*EW_increase);
                end  
            end
            %disp(alertNode);
            %disp(obj.edgeWeightAttacker);
