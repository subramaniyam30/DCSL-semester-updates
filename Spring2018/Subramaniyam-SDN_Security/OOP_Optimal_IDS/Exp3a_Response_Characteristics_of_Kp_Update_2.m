...
kpall = 0.01;
kiall = [0,0.0004,0.0005,0.001,0.004,0.005,0.006,0.008,0.01,0.02,0.05];
%kiall = [0.025,0.03];
...
parfor j=1:numki
    ...
    idsDynamicCtrl.edgeWeightDecay  = 0.3;
    ...
    sum_error = 0;
        for k=1:maxNumTrials
            ...
            idsDynamicCtrl.decayEdgeWeight();
        end
end
    
end

save('Exp3b_Response_with_alert_breaking.mat');